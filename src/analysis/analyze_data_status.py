        ...
        try:
            ...
            if crs_epsg:
                ...
                if 400000 < bounds[0] < 800000 and 1500000 < bounds[1] < 2500000:
                    try:
                        print("  → 座標範囲からEPSG:5897 (VN-2000)と推定")
...
def analyze_lst_data():
    ...
    if results_path.exists():
        ...
        exported = df_results[df_results["exported"]]
        ...
        if len(valid) > 0:
            ...
            print(
                f"  LST範囲: {valid['min_temp_c'].min():.2f} ～ {valid['max_temp_c'].max():.2f}°C"
            )
    ...
    if roi_dir.exists():
        ...
        for roi_file in roi_files:
            try:
                ...
                print(
                    f"    範囲（WGS84）: 経度 {bounds_wgs84[0]:.4f}～{bounds_wgs84[2]:.4f}, "
...
def main():
    ...
    combined = {"gis_data": gis_results, "lst_data": lst_results}
