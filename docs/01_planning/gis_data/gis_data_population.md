...
| 先行研究での採用実績 | S2・S6で言及あり | 特になし | 特になし | 都市気候・LST研究で広く採用される「古典的」標準 | 特になし（防災・人道支援分野での採用が多い） | 特になし（比較的新しいデータセット） |
...
- **本研究との関連**: 先行研究S2・S6で言及されており、都市LST研究での採用実績がある。
...
- **本研究との関連**: 本研究のLSTはLandsat 8の昼間観測（現地時間午前中）に基づくため、地表面温度と人間活動の関係を見る上では、夜間人口より実効人口の方が概念的に整合する可能性がある。ただし先行研究（S2, S6）はいずれも居住人口ベースであるため、比較可能性とのトレードオフになる。
...
- **主候補**: `WorldPop`。ベトナム2019年国勢調査を基準に各年へ按分しており、先行研究（S2, S6）との比較可能性が高い。居住人口ベースで都市構造パラメータとしての解釈もしやすい。
