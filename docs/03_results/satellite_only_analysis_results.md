...
- `data/output/satellite_only/multidate/satellite_only_multidate_summary.csv`
- `data/output/satellite_only/multidate/satellite_only_multidate_summary.json`
- `data/output/satellite_only/multidate/satellite_only_multidate_lst_violin.png`
